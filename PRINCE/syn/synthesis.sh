...
analyze -format verilog  {../RTL/NF_CF_3.v}
analyze -format verilog  {../RTL/PRINCESbox.v}
analyze -format verilog  {../RTL/Q294_1_2order_8r.v}
analyze -format verilog  {../RTL/Q294_2_2order_8r.v}
analyze -format verilog  {../RTL/Q294_3_2order_NoFresh.v}
analyze -format verilog  {../RTL/XOR_3.v}

elaborate PRINCESbox


current_design PRINCESbox
...
write -format verilog -hierarchy -output ../nl/unflattened/PRINCESbox.v

ungroup -all -flatten
write -format verilog -hierarchy -output ../nl/flattened/PRINCESbox.v
