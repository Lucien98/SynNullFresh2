...
analyze -format verilog  {../RTL/Q294_2_2order_NoFresh.v}
analyze -format verilog  {../RTL/SkinnySbox.v}
analyze -format verilog  {../RTL/XOR_3.v}

elaborate SkinnySbox


current_design SkinnySbox
...
write -format verilog -hierarchy -output ../nl/unflattened/SkinnySbox.v

ungroup -all -flatten
write -format verilog -hierarchy -output ../nl/flattened/SkinnySbox.v
