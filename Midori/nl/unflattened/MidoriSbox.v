...
module Affine_num1 ( x1, x2, x3, y1, y2, y3 );
  ...
  output [3:0] y2;
  output [3:0] y3;
  wire   x2_0, x3_0, \x1[3] , \x2[3] , \x2[1] , \x3[3] , \x3[1] ;
  assign x2_0 = x2[0];
  assign x3_0 = x3[0];
  assign y1[2] = \x1[3] ;
  assign \x1[3]  = x1[3];
  ...
  XOR2_X1 U1 ( .A(x3_0), .B(x3[2]), .Z(y3[3]) );
  XOR2_X1 U2 ( .A(x3_0), .B(\x3[3] ), .Z(y3[1]) );
  XOR2_X1 U3 ( .A(x2_0), .B(x2[2]), .Z(y2[3]) );
  XOR2_X1 U4 ( .A(x2_0), .B(\x2[3] ), .Z(y2[1]) );
  XNOR2_X1 U5 ( .A(x1[0]), .B(x1[2]), .ZN(y1[3]) );
  XOR2_X1 U6 ( .A(x1[0]), .B(\x1[3] ), .Z(y1[1]) );
  INV_X1 U7 ( .A(x1[1]), .ZN(y1[0]) );
endmodule
...
module NF_CF_2_num1 ( a, b, c, d, q );
  ...
  NOR2_X1 U1 ( .A1(d[1]), .A2(b[2]), .ZN(n4) );
  XNOR2_X1 U2 ( .A(n4), .B(c[2]), .ZN(q) );
endmodule
...
module NF_CF_2_num8 ( a, b, c, d, q );
  ...
  NAND2_X1 U1 ( .A1(b[3]), .A2(d[3]), .ZN(n2) );
  XNOR2_X1 U2 ( .A(n2), .B(c[3]), .ZN(q) );
endmodule
...
module NF_CF_2_num9 ( a, b, c, d, q );
  ...
  NAND2_X1 U1 ( .A1(b[1]), .A2(d[1]), .ZN(q) );
endmodule
...
module NF_CF_2_num18 ( a, b, c, d, q );
  ...
  NAND2_X1 U1 ( .A1(b[1]), .A2(d[1]), .ZN(n5) );
  OR2_X1 U2 ( .A1(d[1]), .A2(c[1]), .ZN(n4) );
  NAND2_X1 U3 ( .A1(n5), .A2(n4), .ZN(q) );
endmodule
...
module Q12_2_2order_NoFresh ( clk, in1, in2, in3, out1, out2, out3 );
  ...
  NF_CF_2_num4 \Inst[4].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .q(CF_Out[4]) );
  NF_CF_2_num5 \Inst[5].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .q(CF_Out[5]) );
  NF_CF_2_num6 \Inst[6].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .q(
        CF_Out[6]) );
  NF_CF_2_num7 \Inst[7].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .q(CF_Out[7]) );
  ...
  NF_CF_2_num14 \Inst[14].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .q(
        CF_Out[14]) );
  NF_CF_2_num15 \Inst[15].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .q(
        CF_Out[15]) );
  ...
  NF_CF_2_num18 \Inst[18].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .q(
        CF_Out[18]) );
  NF_CF_2_num19 \Inst[19].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, 1'b0, in1[3]}), .q(
        CF_Out[19]) );
  NF_CF_2_num20 \Inst[20].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .q(
        CF_Out[20]) );
  NF_CF_2_num21 \Inst[21].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .q(
        CF_Out[21]) );
  NF_CF_2_num22 \Inst[22].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .q(
        CF_Out[22]) );
  NF_CF_2_num23 \Inst[23].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .q(
        CF_Out[23]) );
  NF_CF_2_num24 \Inst[24].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .q(
        CF_Out[24]) );
  NF_CF_2_num25 \Inst[25].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({in3[3], 1'b0, 1'b0}), .q(
        CF_Out[25]) );
  NF_CF_2_num26 \Inst[26].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .q(
        CF_Out[26]) );
  ...
  XOR_3_7 \InstXOR[0].Compression3  ( .x0(CF_Reg[6]), .x1(CF_Reg[7]), .x2(
        CF_Reg[8]), .q(out3[0]) );
  XOR_3_6 \InstXOR2[1].Compression1  ( .x0(CF_Reg[9]), .x1(CF_Reg[10]), .x2(
        CF_Reg[11]), .q(out1[2]) );
  XOR_3_5 \InstXOR2[1].Compression2  ( .x0(CF_Reg[12]), .x1(CF_Reg[13]), .x2(
        CF_Reg[14]), .q(out2[2]) );
  XOR_3_4 \InstXOR2[1].Compression3  ( .x0(CF_Reg[15]), .x1(CF_Reg[16]), .x2(
        CF_Reg[17]), .q(out3[2]) );
  XOR_3_3 \InstXOR2[2].Compression1  ( .x0(CF_Reg[18]), .x1(CF_Reg[19]), .x2(
        CF_Reg[20]), .q(out1[3]) );
  XOR_3_2 \InstXOR2[2].Compression2  ( .x0(CF_Reg[21]), .x1(CF_Reg[22]), .x2(
        CF_Reg[23]), .q(out2[3]) );
  XOR_3_1 \InstXOR2[2].Compression3  ( .x0(CF_Reg[24]), .x1(CF_Reg[25]), .x2(
        CF_Reg[26]), .q(out3[3]) );
  DFF_X1 \CF_Reg_reg[26]  ( .D(CF_Out[26]), .CK(clk), .Q(CF_Reg[26]) );
  DFF_X1 \CF_Reg_reg[25]  ( .D(CF_Out[25]), .CK(clk), .Q(CF_Reg[25]) );
  DFF_X1 \CF_Reg_reg[24]  ( .D(CF_Out[24]), .CK(clk), .Q(CF_Reg[24]) );
  ...
  DFF_X1 \CF_Reg_reg[1]  ( .D(CF_Out[1]), .CK(clk), .Q(CF_Reg[1]) );
  DFF_X1 \CF_Reg_reg[0]  ( .D(CF_Out[0]), .CK(clk), .Q(CF_Reg[0]) );
  DFF_X1 \out1_reg[1]  ( .D(n257), .CK(clk), .Q(out1[1]) );
  DFF_X1 \out2_reg[1]  ( .D(in2[0]), .CK(clk), .Q(out2[1]) );
  DFF_X1 \out3_reg[1]  ( .D(in3[0]), .CK(clk), .Q(out3[1]) );
  INV_X1 U3 ( .A(in1[0]), .ZN(n257) );
endmodule
